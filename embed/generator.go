//+build ignore
// Generate embeded file box with files from /static
// so they will be included as strings in the binary,
// and made available with embed.Get("filename").
...
const (
	blobFileName string = "generated_blobs.go"
	embedFolder  string = "../static"
)

var funcMap = map[string]interface{}{"conv": fmtByteSlice}
var tmpl = template.Must(template.New("").Funcs(funcMap).Parse(`package embed
